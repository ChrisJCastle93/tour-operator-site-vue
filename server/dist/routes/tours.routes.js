...
router.get("/", (req: Request<P, ResBody, ReqBody, ReqQuery>, res: Response<ResBody>, next: NextFunction): Promise<void> =>
  __awaiter(this, Promise<void> 0, Promise<void> 0, function* () {
...
router.get("/:id", (req: Request<P, ResBody, ReqBody, ReqQuery>, res: Response<ResBody>, next: NextFunction): Promise<void> =>
  __awaiter(this, Promise<void> 0, Promise<void> 0, function* () {
...
router.post("/new", (req: Request<P, ResBody, ReqBody, ReqQuery>, res: Response<ResBody>, next: NextFunction): Promise<void> => {
